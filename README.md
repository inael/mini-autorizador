...
>>>>> COM OS REQUISITOS ATUAIS NÃO E POSSIVEL ZERAR A UTILIZAÇÃO DE IFS, MAS É POSSÍVEL DIMINUIT UTILIZANDO O PADRÃO 
STRATEGY CONFORME UTILIZADO NA IMPLEMENTAÇÃO, SE SURGIR NOVOS TIPOS DE VALIDAÇÕES NADA SERÁ ALTERADO NO SERVICE. 
...
Exemplo: dado que um cartão possua R$10.00 de saldo. Se fizermos 2 transações de R$10.00 ao mesmo tempo, em instâncias diferentes da aplicação, como o sistema deverá se comportar?
 >>>> SIM, É POSSÍVEL E FOI IMPLENTADO UTILIZANDO O SYNCRONIZED PARA APLICAR O PADRÃO DE PROEJETO LOCK. ELE PERMITE
> QUE BLOQUEEE O ACESSO A UM RECURSO COMPARTILHADO.
